				...
				<div class="col-12">
					<div class="card">
						...
						<div class="card-body">
							...
							<label style="padding-left:25%;display: flex;">Search:<input style="width:50%;" type="search" class="form-control form-control-sm" placeholder="Search with email" "></label>
								<thead>
									<tr>
