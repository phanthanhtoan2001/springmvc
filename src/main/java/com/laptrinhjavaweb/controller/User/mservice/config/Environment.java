package com.laptrinhjavaweb.controller.User.mservice.config;
...
//            prop.load(input);
    	try {
            switch (target) {
                case DEV:
                    MoMoEndpoint devEndpoint = new MoMoEndpoint("https://test-payment.momo.vn/v2/gateway/api",
                            "/create",
                          "/refund",
                           "/query",
                            "/confirm",
                           ...
                           "/tokenization/bind",
                            ...
                            "/tokenization/delete");
                    PartnerInfo devInfo = new PartnerInfo("MOMOIY6L20220625", "9hvcineYO8gf5NAk", "LOAQkwrK57jnVGmDBPxmvnxX1sSHPpuj");
