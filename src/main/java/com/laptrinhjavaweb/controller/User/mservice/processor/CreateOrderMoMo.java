...
import com.laptrinhjavaweb.controller.User.mservice.models.HttpResponse;
import com.laptrinhjavaweb.controller.User.mservice.models.PaymentRequest;
import com.laptrinhjavaweb.controller.User.mservice.models.PaymentResponse;
import com.laptrinhjavaweb.controller.User.mservice.enums.*;
...
public class CreateOrderMoMo extends AbstractProcess<PaymentRequest, PaymentResponse> {
    ...
    public static PaymentResponse process(Environment env, String orderId, String requestId, String amount, String orderInfo, String returnURL, String notifyURL, String extraData, com.laptrinhjavaweb.controller.User.mservice.enums.RequestType requestType, Boolean autoCapture) throws Exception {
        try {
    ...
    public PaymentResponse execute(PaymentRequest request) throws MoMoException {
        try {
          ...
          //  System.out.println("\n"+captureMoMoResponse.getMessage() + "/" +captureMoMoResponse.getResultCode()+"\n");
    ...
    public PaymentRequest createPaymentCreationRequest(String orderId, String requestId, String amount, String orderInfo,
                                                           String returnUrl, String notifyUrl, String extraData, com.laptrinhjavaweb.controller.User.mservice.enums.RequestType requestType, Boolean autoCapture) {
